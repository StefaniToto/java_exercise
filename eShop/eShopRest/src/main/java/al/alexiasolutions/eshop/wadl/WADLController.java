package al.alexiasolutions.eshop.wadl;
...
public class WADLController {
    ...
    public @ResponseBody Application generateWadl(HttpServletRequest request) {
        ...
        Doc doc = new Doc();
        doc.setTitle("SIdP REST Service WADL");
        ...
        for (Map.Entry<RequestMappingInfo, HandlerMethod> entry : handletMethods.entrySet()) {
            ...
            for (RequestMethod httpMethod : httpMethods) {
                ...
                for (Annotation[] annotation : annotations) {
                    ...
                    for (Annotation annotation2 : annotation) {
                        ...
                        if (annotation2 instanceof RequestParam ) {
                        	...
                        	Param waldParam = new Param();
                            waldParam.setRequired(true);
                            waldParam.setName(paramType.toString().replaceAll("class ",""));
                            Set<MediaType> consumableMediaTypes = mappingInfo.getConsumesCondition().getConsumableMediaTypes();
                            for (MediaType mediaType : consumableMediaTypes) {
                ...
                if ( !mediaTypes.isEmpty() ) {
                    ...
                    String responseStringType = "";
                    String handlerMethodString = handlerMethod.toString();
                    responseStringType = handlerMethodString.substring(0, handlerMethodString.indexOf(">")+1);
                    ...
                    for (MediaType mediaType : mediaTypes) {
                        ...
                        paramOut.setName(responseStringType.replaceAll("public ", ""));
						wadlResponse.getParam().add(paramOut);
