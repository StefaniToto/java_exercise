...
public class ProductRequestDTO1 implements Serializable {
	...
	public ProductRequestDTO1(int n_idproduct, String t_nome, String t_brand, double n_price, int n_quantity) {
		super();
